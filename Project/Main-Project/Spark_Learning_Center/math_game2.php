...
<div class="p-2 mt-2" id = 'operation1'>

</div>
<div class="p-2 mt-2" id = 'num2'>

</div>
<div class="p-2 mt-2" id = operation2>

</div>
<div class="p-2 mt-2" id = 'num3'>
...
crossorigin="anonymous"></script>
 	<script type="text/javascript">
	  ...
	  var symbol = new Array(level)
		...
		const sign1 = document.getElementById('operation1')
		const txt2 = document.getElementById('num2')
		const sign2 = document.getElementById('operation2')
		const txt3 = document.getElementById('num3')
		...
		function findnumber(){
		    ...
		    let temp
		    if(op[0]<2 && op[1]>1){
		        temp = operator(num[0],operator(num[1],num[2],op[1]),op[0])
		    }
		    else{
		        temp = operator(operator(num[0],num[1],op[0]),num[2],op[1])
		    }
		...
		txt3.innerHTML = num[2]
		sign1.innerHTML = symbol[0]
		sign2.innerHTML = symbol[1]
		// console.log(num) // [ 9, 9, 1 ]
		// console.log(symbol) // [ '*', '+' ]
