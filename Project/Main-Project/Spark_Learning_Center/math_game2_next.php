					...
					<div class="col-md-12" >
						<div class="mm" style="height:auto">
							...
							<div class="form-group mt-4">
								<a href="math_game2_process.php"><button type="submit" class="form-control btn btn-dark submit px-3 mt-2 mx-6" style="font-weight: bold;width: 10rem;">Next</button></a>
							</div>
						</div>
					</div>
				</div>
